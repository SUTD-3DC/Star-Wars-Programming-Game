...
falcon = pygame.mixer.Sound("sounds/powerupandblast.ogg")
trooper = pygame.mixer.Sound("sounds/stormtrooper1.ogg")
...
def loadLevel(level):
    ...
    holeCoords = [[],[[570,180],[570,210]],[],[[390,0],[390,30],[390,60],[390,90],[390,120],[390,150],[390,180],[390,210],[390,240],[390,270]
                  ...
                  ,[],[[360,150],[360,300],[360,420]],[[240,180],[240,360]],[],[[180,210],[180,240],[210,450],[210,480],[210,510],[360,270],[360,270],[360,270],[360,300],[360,330],[570,150],
                                [570,180],[570,210],[510,390],[510,420]],[]]

    vader_face = [1,0,0,2,2,0,0,1,1,3] # 0-Down, 1-Left, 2- Up, 3-Right
    blueprint_xy = [[],[],[],[],[120,150],[],[240,240],[],[],[]]
...
def gameLoop():
    ...
    global lead_x, lead_y, lead_direction,holes,blueprintExist, time_limit
    gameWon = False
    gameExit = False
    gameOver = False
    leftCollision = False
